...
export const CatalogEventPage = () => {
  ...
  if (eventQuery.isError || !eventQuery.data) {
    return (
      <div className="panel">
        <p className="text-destructive">Catalog event not found.</p>
  ...
  return (
    <section className="space-y-4">
      <header className="panel">
        ...
        <h1 className="font-display text-4xl font-bold tracking-tight">{eventQuery.data.event.name}</h1>
        <p className="mt-2 text-sm text-shell-ink/70">{eventQuery.data.event.description ?? 'No description.'}</p>
      </header>

      <div className="grid gap-4 xl:grid-cols-[1.1fr_0.9fr]">
        <section className="panel space-y-3">
          <h2 className="font-display text-2xl font-bold tracking-tight">Properties</h2>
        ...
        <section className="panel space-y-3">
          <h2 className="font-display text-2xl font-bold tracking-tight">Version History</h2>
